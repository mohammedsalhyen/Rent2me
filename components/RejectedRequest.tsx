...
const RejectedRequest = ({ user }: any) => {
    ...
    useEffect(() => {
        const fetchRequests = async () => {
            try {
                ...
                queryParams.append('status',0 as unknown as string);
    ...
    return (
        <div className='main-prop border-t-2 border-[#DDD]'>
            <div>
                <p className='text-3xl text-red-600 font-semibold mb-10'>Your Rejected Requests</p>
            </div>
            {requests.length === 0 ? (
